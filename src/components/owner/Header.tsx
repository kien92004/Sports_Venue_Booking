  ...
  return (
    <nav className="navbar navbar-expand-lg navbar-light bg-white shadow-sm fixed-top border-bottom">
      <div className="container-fluid">
        {/* Logo */}
        <a className="navbar-brand d-flex align-items-center" href="/owner/dashboard">
          ...
          <div className="position-relative me-2">
            <button className="btn p-0 border-0 bg-transparent"
              ...
              <div className="d-flex justify-content-center align-items-center gap-2">
                ...
                <i className={`bi ${avatarDrop ? "bi-chevron-up" : "bi-chevron-down"} text-secondary d-none d-md-inline`}></i>
              </div>
